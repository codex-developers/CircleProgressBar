...
public class CircleProgressView extends View {
    ...
    final AnimationHandler mAnimationHandler = new AnimationHandler(this);
    ...
    private final Paint mBarSpinnerPaint = new Paint();
    private final Paint mBarStartEndLinePaint = new Paint();
    private final Paint mBackgroundCirclePaint = new Paint();
    private final Paint mRimPaint = new Paint();
    private final Paint mTextPaint = new Paint();
    private final Paint mUnitTextPaint = new Paint();
    private final Paint mOuterContourPaint = new Paint();
    private final Paint mInnerContourPaint = new Paint();
    //Other
    // The text to show
